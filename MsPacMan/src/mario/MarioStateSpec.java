...
public class MarioStateSpec extends StateSpec {
	...
	protected Collection<StringFact> initialiseTypePredicateTemplates() {
		...
		typeMap.add(new StringFact("mario", new Class[] { Player.class }));
		typeMap.add(new StringFact("coin", new Class[] { Dot.class }));
		typeMap.add(new StringFact("mushroom", new Class[] { PowerDot.class }));
		typeMap.add(new StringFact("fireFlower", new Class[] { Ghost.class }));
		...
		typeMap.add(new StringFact("shell", new Class[] { Junction.class }));
	 ...
	 */
	public WeightedDirection applyAction(StringFact action, MarioState state) {
