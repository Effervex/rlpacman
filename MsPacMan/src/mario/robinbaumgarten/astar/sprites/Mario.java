package mario.robinbaumgarten.astar.sprites;
...
public class Mario extends Sprite implements Cloneable
{
	...
	public Object clone() throws CloneNotSupportedException
    {
    	...
    	m.fire = fire;
    	m.height = height;
    	m.invulnerableTime = invulnerableTime;
    	m.jumpTime = jumpTime;
    	m.kind = kind;
    	m.large = large;
    	m.lastAccurateX = lastAccurateX;
    	m.lastAccurateY = lastAccurateY;
    	m.layer = layer;
    	m.mapX = mapX;
    	m.mapY = mapY;
    	m.mayJump = mayJump;
    	m.onGround = onGround;
    	m.powerUpTime = powerUpTime;
    	m.runTime = runTime;
    	m.sliding = sliding;
    	m.status = status;
    	m.unknownYA = unknownYA;
    	m.wasOnGround = wasOnGround;
    	m.width = width;
    	m.winTime = winTime;
    	m.world = world;
    	m.x = x;
    	m.xa = xa;
    	m.xDeathPos = xDeathPos;
    	m.xJumpSpeed = xJumpSpeed;
    	m.xOld = xOld;
    	m.y = y;
    	m.ya = ya;
    	m.yDeathPos = yDeathPos;
    	m.yJumpSpeed = yJumpSpeed;
    	m.yOld = yOld;
    	return m;    	
    }
