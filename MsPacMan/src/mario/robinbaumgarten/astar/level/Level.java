package mario.robinbaumgarten.astar.level;
...
import mario.ObservationConstants;
...
public class Level implements Cloneable {
	...
	public static void loadBehaviors() {
		...
		// This is the data from tiles.dat. Could load it from the file, but to
		// avoid i/o problems, data is here.
