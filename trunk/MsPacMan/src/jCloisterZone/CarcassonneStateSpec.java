...
public class CarcassonneStateSpec extends StateSpec {
	...
	protected Collection<RelationalPredicate> initialisePredicateTemplates() {
		...
		structure[0] = "tile";
		predicates.add(new RelationalPredicate("currentTile", structure, false));

		structure = new String[1];
		structure[0] = "player";
		predicates.add(new RelationalPredicate("currentPlayer", structure, false));
		...
		structure[0] = "tile";
		structure[1] = "terrain";
		predicates.add(new RelationalPredicate("tileContains", structure, false));

		// Tile location
		structure = new String[2];
		structure[0] = "tile";
		structure[1] = "location";
		predicates.add(new RelationalPredicate("tileLocation", structure, false));
		...
		predicates
				.add(new RelationalPredicate("numSurroundingTiles", structure, false));

		// If the location is in a cloister's zone.
		structure = new String[2];
		structure[0] = "location";
		structure[1] = "cloister";
		predicates.add(new RelationalPredicate("cloisterZone", structure, false));
		...
		structure[1] = NumberEnum.Integer.toString();
		structure[2] = NumberEnum.Integer.toString();
		predicates.add(new RelationalPredicate("edgeDirection", structure, true));
		...
		structure[1] = NumberEnum.Integer.toString();
		structure[2] = "terrain";
		predicates.add(new RelationalPredicate("placedMeeples", structure, false));
		...
		structure[0] = "player";
		structure[1] = NumberEnum.Integer.toString();
		predicates.add(new RelationalPredicate("meeplesLeft", structure, false));
